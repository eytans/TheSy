...
(assert (forall ((n Int) (m Int)) (=> (and (>= n 0) (>= m 0)) (= (nmin n m) (ite (less n m) n m)))))
(assert (forall ((n Int) (m Int)) (=> (and (>= n 0) (>= m 0)) (>= (nmin n m) 0))))
(assert (not 
(forall ((a Int) (b Int) (c Int)) (=> (and (>= a 0) (>= b 0) (>= c 0)) (= (nmin (nmin a b) c) (nmin a (nmin b c))))) ; G31 
))
(check-sat)

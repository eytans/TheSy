...
(assert (forall ((n Int) (m Int)) (=> (and (>= n 0) (>= m 0)) (= (qmult 0 n m) m))))
(assert (forall ((n Int) (m Int) (p Int)) (=> (and (>= n 0) (>= m 0) (>= p 0)) (= (qmult (+ 1 n) m p) (qmult n m (plus p m))))))
(assert (forall ((n Int) (m Int) (p Int)) (=> (and (>= n 0) (>= m 0) (>= p 0))  (>= (qmult n m p) 0))))

; sub-goals
(assert 
(forall ((x Int) (y Int) (z Int)) (=> (and (>= x 0) (>= y 0) (>= z 0)) (= (plus (plus x y) z) (plus x (plus y z)))))  ; G74 
)

; conjecture
(assert (not 
(forall ((x Int) (y Int) (z Int)) (=> (and (>= x 0) (>= y 0) (>= z 0)) (= (plus (mult x y) z) (qmult x y z)))) ; G85 
))
(check-sat)

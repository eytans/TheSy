...
(assert (forall ((x (Set Int))) (= (lst-union (as emptyset (Set Int)) x) x)))
(assert (forall ((n Int) (x (Set Int)) (y (Set Int))) (= (lst-union (union (singleton n) x) y) (ite (lst-mem n y) (lst-union x y) (union (singleton n) (lst-union x y))))))
(assert (forall ((x (Set Int)) (y (Set Int))) (= (lst-union x y) (union x y))))
(assert (not 
(forall ((x Int) (y (Set Int)) (z (Set Int))) (=> (lst-mem x y) (lst-mem x (lst-union y z))))  ; G42 
))
(check-sat)

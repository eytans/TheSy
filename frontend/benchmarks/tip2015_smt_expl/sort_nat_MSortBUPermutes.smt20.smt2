...
(declare-fun deleteBy (fun13 sk list3) list3)
(declare-fun isPermutation (list3 list3) Bool)
(declare-const lam fun1)
(declare-fun lam2 (sk) fun15)
...
(assert (forall ((x fun13) (y sk)) (= (deleteBy x y nil3) nil3)))
(assert
  (forall ((x fun13) (y sk) (y2 sk) (ys list3))
...
(assert (forall ((x4 sk)) (= (apply13 lam3 x4) (lam2 x4))))
(assert
  (forall ((x4 sk) (x5 sk)) (= (apply15 (lam2 x4) x5) (= x4 x5))))

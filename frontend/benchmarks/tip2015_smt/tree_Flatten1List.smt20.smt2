...
(declare-fun concatMap (fun13 list) list2)
(declare-fun concatMap2 (fun12 list2) list2)
...
(assert (forall ((f fun12)) (= (concatMap2 f nil2) nil2)))
(assert
  (forall ((f fun12) (y sk) (xs list2))
    (= (concatMap2 f (cons2 y xs))
      (++ (apply12 f y) (concatMap2 f xs)))))
(assert (forall ((f fun13)) (= (concatMap f nil) nil2)))
(assert
  (forall ((f fun13) (y Tree) (xs list))
    (= (concatMap f (cons y xs)) (++ (apply13 f y) (concatMap f xs)))))
(assert
